...
{{--    <form method="POST" action="{{ route('savings-goals.store') }}" class="bg-white rounded-lg shadow-sm p-6 border border-neutral-100 mb-8">--}}
{{--        @csrf--}}
{{--        <h2 class="text-xl font-semibold text-neutral-800 mb-6">Create New Savings Goal</h2>--}}

{{--        <div class="space-y-4">--}}
{{--            <div>--}}
{{--                <label for="goal_name" class="block text-sm font-medium text-neutral-700 mb-1">Goal Name</label>--}}
...
{{--            <div>--}}
{{--                <label for="target_amount" class="block text-sm font-medium text-neutral-700 mb-1">Target Amount (€)</label>--}}
{{--                <input type="number" name="target_amount" id="target_amount" min="0" step="0.01" required--}}
{{--                       class="w-full rounded-md border-neutral-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">--}}
{{--                @error('target_amount')--}}
{{--                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>--}}
{{--                @enderror--}}
...
{{--            <div>--}}
{{--                <label for="target_date" class="block text-sm font-medium text-neutral-700 mb-1">Target Date</label>--}}
