...
@section('main')
    ...
    <div class=" bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Update Book </h2>
        ...
        <form action="/updateData/{{$book->id}}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            @csrf
